...
public class MostrarCursoProfessores extends JFrame implements ActionListener {
	public MostrarCursoProfessores() {
		...
		String cursos []= {"Engenharia","Matematica","Quimica"};
