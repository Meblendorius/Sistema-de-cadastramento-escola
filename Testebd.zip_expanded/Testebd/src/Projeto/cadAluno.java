...
public class cadAluno extends JFrame implements ActionListener {
	...
	public cadAluno() {
		...
		ti= new JLabel("Cadastramento de Alunos");
		...
		balterar.setLocation(binc.getX()+150,binc.getY());
		
		bexcluir= new JButton("Excluir");
		bexcluir.setSize(120,50);
		bexcluir.setBackground(Color.decode("#91b4ed"));
		bexcluir.addActionListener(this);
		bexcluir.setLocation(balterar.getX()+150,balterar.getY());
		...
		bsair.setLocation(bexcluir.getX()+150,bexcluir.getY());
